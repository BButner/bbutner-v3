      ...
      <BarButton.Button>
        <svg
          ...
          <circle
            ...
            r="216"
            fill="none"
            stroke={desktop.currentThemeMode === ThemeTitle.Dark ? 'white' : 'black'}
            strokeWidth="40"/>
          <g>
            <polygon
          ...
          <div>
            ...
            <div className="flex items-center justify-center space-x-4">
              <svg
                ...
                height={20}
                className={clsx(
                  desktop.currentThemeMode === ThemeTitle.Dark ? 'fill-white' : 'fill-zinc-500'
                )}>
              ...
              {shouldPlayBeVisible() && <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                             ...
                                             width={24}
                                             height={24}
                                             className={desktop.currentThemeMode === ThemeTitle.Dark ? 'fill-white' : 'fill-zinc-500'}>
                <path
